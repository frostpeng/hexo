...
Post.prototype.create = function(data, replace, callback) {
  ...
  //frostpeng 魔改 时间展示，用来做周报wiki
  data.time_category = data.date.format('YYYY-MM');
  // data.time_title = data.date.format('YYYY-MM-DD');
  data.time_title = this._getMonthWeek();
...
Post.prototype._getMonthWeek = function (){ 
  /* 
  a = d = 当前日期 
